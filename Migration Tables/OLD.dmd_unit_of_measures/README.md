Migration script: MySQL `qitech.dmd_unit_of_measures` -> Postgres `public.dmd_lookup_units_of_measure`
...
- `cd` is used as the target key value and converted to the Postgres integer `id`.
